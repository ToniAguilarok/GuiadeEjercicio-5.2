...
public class ComprarSupermercado {
	...
	public static void main(String[] args)  {
		...
		File f = new File("D:\\Toni2\\Argentina programa\\Introduccion a Java\\UTN de tucuman\\clase 5 08-03\\carritoComprasItems.txt");
        String cadena;
        ...
        try {
            ...
            Persona per1 = new Persona("Toni","Aguilar", 36458243);//se ejemplariza persona
...
public static void cargarProductos(String cadena, Producto cargaProducto[],int i) {
	...
	cargaProducto[i] = new Producto(codigo,nombre," ",precio,stock);
}
	
public static void mostrarCompras(ItemCarrito cargaItem[],Carrito_Compras carr1, Persona per1) {
	
		double suma =0;
		System.out.println("Carrito de compras: "+carr1.dameNumero()+"\n\nCliente: "+per1.un_nombre());
...
public static void mostrarDescuento(double suma) {
     ...
     if (descuento%2!=0) {
    	 ...
    	 System.out.println("\nEl monto con descuento es: "+ desc1.montoFinal(suma)+"\n");
     }
     else {
